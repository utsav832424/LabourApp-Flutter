...
class SCarpenter extends StatefulWidget {
  SCarpenter(
      {Key? key,
      required this.data,
      required this.type,
  ...
  @override
  State<SCarpenter> createState() => _SCarpenterState();
}

class _SCarpenterState extends State<SCarpenter> {
  ...
  TextEditingController editcarpenterfullday = TextEditingController();
  TextEditingController editcarpenterothrs = TextEditingController();
                                    ...
                                    children: [
                                      GestureDetector(
                                        onTap: () {
                                          ...
                                          editcarpenterfullday.text =
                                              data['carpenterfullday']
                                                  .toString();
                                          editcarpenterothrs.text =
                                              data['carprnterothrs'].toString();
                                                      ...
                                                      child: Column(
                                                        children: [
                                                          ...
                                                          TextFormField(
                                                            // readOnly: true,
                                                            controller:
                                                                editcarpenterfullday,
                                                            validator: (value) {
                                                              if (value ==
                                                                      null ||
                                                                  value
                                                                      .isEmpty) {
                                                                return "Please enter Carpenter Full Day";
                                                              }
                                                              return null;
                                                            },
                                                            decoration:
                                                          ...
                                                          TextFormField(
                                                            ...
                                                            validator: (value) {
                                                              if (value ==
                                                                  ...
                                                                  value
                                                                      .isEmpty) {
                                                                return "Please enter Carpenter othrs";
                                                              }
                                                              return null;
                                                            },
                                                            decoration:
