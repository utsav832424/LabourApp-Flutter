...
class Receivedtodetail extends StatefulWidget {
  Receivedtodetail({Key? key, required this.name, required this.id})
      : super(key: key);
  final id;
  final name;
  @override
  State<Receivedtodetail> createState() => _ReceivedtodetailState();
}

class _ReceivedtodetailState extends State<Receivedtodetail> {
