...
class Operator_NameDetail extends StatefulWidget {
  Operator_NameDetail(
      {Key? key,
  ...
  @override
  State<Operator_NameDetail> createState() => _Operator_NameDetailState();
}

class _Operator_NameDetailState extends State<Operator_NameDetail> {
  ...
  init() async {
    ...
    var resData = await apiService.getcall(
        "operator/getnameByidCop?from_date=${txtController.text}&to_date=${txtController2.text}&user_id=${widget.user_id}&name=${widget.name}");
    log("${resData}");
    if (mounted) {
      setState(() {
        data = resData['data'];
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onPressed:
                                                                            ...
                                                                            if (editname.text.isEmpty) {
                                                                              ...
                                                                              param['date1'] = txtController1.text;
