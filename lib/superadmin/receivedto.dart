...
import 'package:abc_2_1/superadmin/receivedtodetail.dart';
import 'package:flutter/material.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:flutter_typeahead/flutter_typeahead.dart';

class SReceivedto extends StatefulWidget {
  SReceivedto(
  ...
  @override
  State<SReceivedto> createState() => _SReceivedtoState();
}

class _SReceivedtoState extends State<SReceivedto> {
                            ...
                            child: GestureDetector(
                              onTap: () {
                                Navigator.of(context).push(
                                  PageRouteBuilder(
                                    pageBuilder: (_, __, ___) => Receivedtodetail(
                                        name:
                                            "${widget.type == 1 ? item['sitename'] : item['receivername']} ",
                                        id: item['user_id']),
                                  ),
