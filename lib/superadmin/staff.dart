...
import 'package:abc_2_1/superadmin/staffdetail.dart';
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';
import 'package:shared_preferences/shared_preferences.dart';

class SStaff extends StatefulWidget {
  SStaff({Key? key}) : super(key: key);

  @override
  State<SStaff> createState() => _SStaffState();
}

class _SStaffState extends State<SStaff> {
  ...
  init() async {
    ...
    var resData = await apiService.getcall(
        "staff/group?from_date=${txtController.text}&to_date=${txtController2.text}&user_id=${userid}");
    log("${resData}");
    if (mounted) {
      setState(() {
        data = resData['data'];
