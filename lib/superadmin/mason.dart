...
class SMason extends StatefulWidget {
  SMason(
      {Key? key,
      required this.data,
      this.contarator,
  ...
  @override
  State<SMason> createState() => _SMasonState();
}

class _SMasonState extends State<SMason> {
  ...
  TextEditingController editmansonothrs = TextEditingController();
  TextEditingController editmansonfullday = TextEditingController();
                                ...
                                GestureDetector(
                                  onTap: () {
                                    ...
                                    addcontactorname.text =
                                        data['contractorname'];
                                    editmansonfullday.text =
                                        data['masonfullday'].toString();
                                    editmansonothrs.text =
                                                  ...
                                                  children: [
                                                    ...
                                                    TextFormField(
                                                      ...
                                                      validator: (value) {
                                                        if (value == null ||
                                                            value.isEmpty) {
                                                          return "Please enter Manson Full Day";
                                                        }
                                                        return null;
                                                      },
                                                      decoration:
                                                    ...
                                                    TextFormField(
                                                      ...
                                                      validator: (value) {
                                                        if (value == null ||
                                                            value.isEmpty) {
                                                          return "Please enter Manson othrs";
                                                        }
                                                        return null;
                                                      },
                                                      decoration:
