...
import 'dart:io';
import 'package:abc_2_1/superadmin/operator_namedetail.dart';
...
class OperatorDetail extends StatefulWidget {
  OperatorDetail({Key? key, required this.user_id, required this.refresh})
      : super(key: key);
  final user_id;
...
class _OperatorDetailState extends State<OperatorDetail> {
  ...
  init() async {
    ...
    var resData = await apiService.getcall(
        "operator?from_date=${txtController.text}&to_date=${txtController2.text}&user_id=${widget.user_id}");
    log("${resData}");
    if (mounted) {
      setState(() {
        data = resData['data'];
                                  ...
                                  : () async {
                                      ...
                                      if (resData['success'] == 1) {
                                        openFile(
                                            ...
                                            filename:
                                                'operatorSuper${DateFormat('dd-MM-yyyy H-m-s').format(DateTime.now())}.pdf');
                                      } else {
                                        ToastMsg(
                                          resData['message'],
                                          15,
                                      ...
                                      if (resData['success'] == 1) {
                                        openFile(
                                            url:
                                                'http://89.116.229.150:3003/getfile?url=${resData['fileLink']}',
                                            filename:
                                                'operatorSuper${DateFormat('dd-MM-yyyy H-m-s').format(DateTime.now())}.xlsx');
                                      } else {
                                        ToastMsg(
                                          resData['message'],
                                          15,
                                                                    ...
                                                                    child: Autocomplete<
                                                                      ...
                                                                      optionsBuilder:
                                                                        ...
                                                                        if (textEditingValue.text ==
                                                                          ...
                                                                          param['user_id'] =
                                                                              item['user_id'];
                                                                          var resdata = await apiService.getUserSuggestion(
                                                                              'operator/searchName',
                                                                              param);
                                                                      ...
                                                                      onSelected:
                                                                        ...
                                                                        getid = searchUSer
                                                                            .where((x) =>
                                                                                x['name'].toLowerCase().contains(suggestion.toLowerCase()))
                                                                            .toList();
                                                                        log("getid ${getid}");
                                                                        for (var item
                                                                            in getid) {
