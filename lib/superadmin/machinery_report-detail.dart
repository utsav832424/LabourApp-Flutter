...
import 'package:abc_2_1/superadmin/machinarySuppliersuper.dart';
import 'package:abc_2_1/superadmin/machineryvehical.dart';
...
class SMachinery_report_detail extends StatefulWidget {
  ...
  @override
  State<SMachinery_report_detail> createState() =>
      _SMachinery_report_detailState();
}

class _SMachinery_report_detailState extends State<SMachinery_report_detail> {
  ...
  init() async {
    ...
    var resData = await apiService.getcall(
        "machinery?from_date=${txtController.text}&to_date=${txtController2.text}&offset=0&length=20&user_id=${widget.supliername}");
    log("${resData}");
    if (mounted) {
      setState(() {
                                      ...
                                      : () async {
                                          ...
                                          if (resData['success'] == 1) {
                                            openFile(
                                                ...
                                                filename:
                                                    'MachinerySuper${DateFormat('dd-MM-yyyy H-m-s').format(DateTime.now())}.pdf');
                                          } else {
                                            ToastMsg(
                                              resData['message'],
                                              15,
                                          ...
                                          if (resData['success'] == 1) {
                                            openFile(
                                                url:
                                                    'http://89.116.229.150:3003/getfile?url=${resData['fileLink']}',
                                                filename:
                                                    'Machinery${DateFormat('dd-MM-yyyy H-m-s').format(DateTime.now())}.xlsx');
                                          } else {
                                            ToastMsg(
                                              resData['message'],
                                              15,
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            TypeAheadFormField(
                                                                              ...
                                                                              suggestionsCallback: (pattern) async {
                                                                                ...
                                                                                param['type'] = 1;
                                                                                // log("${param}");
                                                                                return await apiService.getUserSuggestion('machinery/searchName', param);
                                                                              },
                                                                              ...
                                                                              onSuggestionSelected: (dynamic suggestion) {
                                                                                contractornameid = suggestion['id'];
                                                                                editsuppliername.text = suggestion['name'];
                                                                            ...
                                                                            TypeAheadFormField(
                                                                              ...
                                                                              onSuggestionSelected: (dynamic suggestion) {
                                                                                materialnameid = suggestion['id'];
                                                                                editvehicleno.text = suggestion['name'];
