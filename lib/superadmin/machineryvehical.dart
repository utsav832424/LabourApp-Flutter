...
class Machineryvehical extends StatefulWidget {
  Machineryvehical({Key? key, required this.vecno, required this.adminid})
      : super(key: key);
  final adminid;
  final vecno;

  @override
  State<Machineryvehical> createState() => _MachineryvehicalState();
}

class _MachineryvehicalState extends State<Machineryvehical> {
