...
class machinarySupplier extends StatefulWidget {
  const machinarySupplier({this.vecno, this.userid, super.key});
  final vecno;
  final userid;
  @override
  State<machinarySupplier> createState() => _machinarySupplierState();
}

class _machinarySupplierState extends State<machinarySupplier> {
