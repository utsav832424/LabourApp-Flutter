import 'package:abc_2_1/admin/sendardetail.dart';
import 'package:abc_2_1/apiservice.dart';
import 'package:flutter/material.dart';
import 'package:shared_preferences/shared_preferences.dart';

class Receivedto extends StatefulWidget {
  Receivedto({Key? key, required this.data}) : super(key: key);
  final data;
  @override
  State<Receivedto> createState() => _ReceivedtoState();
}

class _ReceivedtoState extends State<Receivedto> {
                            ...
                            child: GestureDetector(
                              onTap: () {
                                Navigator.of(context).push(
                                  PageRouteBuilder(
                                    pageBuilder: (_, __, ___) => Sendardetail(
