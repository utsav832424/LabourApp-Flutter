...
import 'package:abc_2_1/admin/operator_detail.dart';
...
class Operator extends StatefulWidget {
  Operator({Key? key}) : super(key: key);
...
class _OperatorState extends State<Operator> {
  ...
  init() async {
    ...
    log("${DateFormat('dd-MM-yyyy H-m-s').format(DateTime.now())}");
    setState(() {
      loader = true;
    });
    ...
    var resData = await apiService.getcall(
        "operator?from_date=${txtController.text}&to_date=${txtController2.text}&user_id=${userid}");
    log("${resData}");
    if (mounted) {
      setState(() {
        data = resData['data'];
    ...
    var resdata1 =
        await apiService.getcall('operator/getAllSuggName?user_id=${userid}');
    log("${resdata1}");
    if (mounted) {
      setState(() {
        data1 = resdata1['data'];
                            ...
                            onPressed: () {
                              showDialog<void>(
                                ...
                                builder: (BuildContext context) {
                                  return AlertDialog(
                                    title: const Text('Add Operator Name'),
                                    actions: <Widget>[
                                      Column(
                                        children: [
                                          TextFormField(
                                                    ...
                                                    onPressed: () async {
                                                      var resData =
                                                          await apiService.getcall(
                                                              "operator/getName?user_id=${userid}");
                                                                                  ...
                                                                                  GestureDetector(
                                                                                    onTap: () {
                                                                                      ...
                                                                                      showDialog<void>(
                                                                                        ...
                                                                                        builder: (BuildContext context) {
                                                                                          return AlertDialog(
                                                                                            title: const Text('Edit Operator Name'),
                                                                                            actions: <Widget>[
                                                                                              Column(
                                                                                                children: [
                                                                                                  TextFormField(
                                                                                                          ...
                                                                                                          child: ElevatedButton(
                                                                                                            ...
                                                                                                            onPressed: () async {
                                                                                                              if (editcontactorname.text.isEmpty) {
                                                                                                                ...
                                                                                                                var resData = await apiService.postCall('operator/editName', data);
                                                                                  ...
                                                                                  Container(
                                                                                    child: GestureDetector(
                                                                                      onTap: () async {
                                                                                        var data = Map<String, dynamic>();
                                                                                        data['id'] = item['id'];
                                                                                        var resData = await apiService.postCall('operator/deleteName', data);
                              ...
                              GestureDetector(
                                onTap: isExportPdfLoader
                                    ...
                                    : () async {
                                        ...
                                        var resData = await apiService.getCall(
                                            'http://89.116.229.150:3003/api/operator/downloadGetAllPdf?' +
                                                query);
                                        ...
                                        if (resData['success'] == 1) {
                                          openFile(
                                              ...
                                              filename:
                                                  'operatorR${DateFormat('dd-MM-yyyy H-m-s').format(DateTime.now())}.pdf');
                                        } else {
                                          ToastMsg(
                                            resData['message'],
                                            15,
                              ...
                              GestureDetector(
                                onTap: isExportPdfLoader
                                    ...
                                    : () async {
                                        ...
                                        var resData = await apiService.getCall(
                                            'http://89.116.229.150:3003/api/operator/downloadGetAllExcel?' +
                                                query);
                                        ...
                                        if (resData['success'] == 1) {
                                          openFile(
                                              url:
                                                  'http://89.116.229.150:3003/getfile?url=${resData['fileLink']}',
                                              filename:
                                                  'operatorR${DateFormat('dd-MM-yyyy H-m-s').format(DateTime.now())}.xlsx');
                                        } else {
                                          ToastMsg(
                                            resData['message'],
                                            15,
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onPressed:
                                                                              ...
                                                                              if (editname.text.isEmpty) {
                                                                                ...
                                                                                param['id'] = item['id'];
                                                                                var resData = await apiService.postCall('operator/editOperator', param);
                                                                                if (resData['success'] == 0) {
                                                                                  ToastMsg(
                                                                                    resData['message'],
                                                                                    15,
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          suggestionsCallback:
                                                                            ...
                                                                            return await apiService.getUserSuggestion('operator/searchName',
                                                                                data);
                                                                          },
                                                                          itemBuilder:
                                                                              ...
                                                                              onPressed: isLoad
                                                                                  ...
                                                                                  : () async {
                                                                                      if (loginForm.currentState!.validate()) {
                                                                                        ...
                                                                                        print(data);
                                                                                        var login = await apiService.postCall('operator', data);
                                                                                        setState(
                                                                                          () {
                                                                                            isLoad = false;
                                                                                          },
                                                                        ...
                                                                        optionsBuilder:
                                                                          ...
                                                                          if (textEditingValue.text ==
                                                                            ...
                                                                            data['user_id'] =
                                                                                userid.toString();
                                                                            var resdata =
                                                                                await apiService.getUserSuggestion('operator/searchName', data);
